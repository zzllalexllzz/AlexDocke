            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class='user' action='enrutador.php' method='POST' enctype="multipart/form-data">
                        ...
                        <div class='form-group'>
                            <input type='text' name='web' class='form-control' placeholder='Enlace Web' size="255" required>
                        </div>
                        <div class='form-group'>
                            <input type='number' name='precio' class='form-control' placeholder='Precio' required>
                        </div>
                        <div class='form-group'>
                            <input type='file' name='imagen' class='form-control' placeholder='' required>
                        </div>
                        <div class='form-group'>
