<?php
    ...
    class ControladorRegalos {
        ...
        public static function nuevoRegalo($regalo){
            ...
            $regaloInsert = new Regalos(0,$regalo["idUsuario"],$regalo["nombre"],$regalo["destinatario"],$regalo["precio"],$regalo["estado"],$regalo["anio"]);
            RegalosBD::nuevoRegalo($regaloInsert);
            echo "<script>window.location='enrutador.php?accion=mostrarRegalos';</script>";
        }
