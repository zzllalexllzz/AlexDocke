...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="enrutador.php?accion=mostrarPartidas">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php
                            if ($_REQUEST["accion"]=="mostrarPartidas") {
                                echo '<a class="collapse-item" href="#" data-toggle="modal" data-target="#anadirPartida">Nueva Partida <i class="bi bi-plus-square text-success"></i></a>';
                            } else {
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php
                                    ...
                                    if ($_SESSION['jugador']) {
                                        echo "<span class='mr-2 d-none d-lg-inline text-gray-900 small'>".unserialize($_SESSION['jugador'])->getEmail()."</span>";
                                    } else {
