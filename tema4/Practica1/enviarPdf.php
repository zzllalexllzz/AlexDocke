...
try {
    ...
    $mail->Username   = 'alexandersmr2019@gmail.com';                     //SMTP username
    $mail->Password   = 'pkwwbiehgvaaajee';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('alexandersmr2019@gmail.com', 'Alexander BR');
    $mail->addAddress('alexandersmr2019@gmail.com', 'Alumno');     //Add a recipient
