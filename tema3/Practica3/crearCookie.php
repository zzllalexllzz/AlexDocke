...
if ($_GET) {
    ...
    if (isset($_COOKIE["servidor"])) {
        ...
        setcookie('servidor', $gustosString, time() + 60000, "/tema3", "dashboard.heroku.com", false, true);
        //echo "Cookie creada";
    } else {
        //Primera vez que entra
        $cad="CreacionCookie#moda-0#deporte-0#juegos-0";
        $cad=encriptar($cad, 3);
        setcookie('servidor', $cad, time() + 60000, "/tema3", "dashboard.heroku.com", false, true);
    }
